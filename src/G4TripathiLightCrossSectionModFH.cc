...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//
// MODULE:              G4TripathiLightCrossSectionModFH.cc
//
// Version:		B.1
// Date:		15/04/04
// Author:		P R Truscott
...
G4TripathiLightCrossSectionModFH::G4TripathiLightCrossSectionModFH ()
 : G4VCrossSectionDataSet("TripathiLightIons")
{
  ...
  // G4TripathiLightCrossSectionModFH::GetCrossSection is going to be called from
  // within G4TripathiLightCrossSectionModFH::GetCrossSection to check whether the
...
//
G4bool
G4TripathiLightCrossSectionModFH::IsElementApplicable(const G4DynamicParticle* theProjectile,
...
//
G4double
G4TripathiLightCrossSectionModFH::GetElementCrossSection(const G4DynamicParticle* theProjectile,
						    G4int ZT, const G4Material*)
{
  ...
  if ((AT==1 && ZT==1) || (AP==1 && ZP==1)) {
    ...
    else                     {T1 = 40.0; G = 50.0;}//G = 75.0;} // Modified following F. Horst et al. (2019)
    //D = 2.77 - 8.0E-3*AT + 1.8E-5*AT*AT-0.8/(1.0+G4Exp((250.0-E)/G));
    D = 2.2 -8.0E-3*AP + 1.8E-5*AP*AP-0.3/(1.0+G4Exp((120.0-E/G))); //Modified cross section following F. Horst et al. (2019)
  }
  else if (AT==4 && ZT==2) {
