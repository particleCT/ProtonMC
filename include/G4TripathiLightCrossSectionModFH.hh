...
// ********************************************************************
//
#ifndef G4TripathiLightCrossSectionModFH_h
#define G4TripathiLightCrossSectionModFH_h
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
//
// MODULE:              G4TripathiLightCrossSectionModFH.hh
//
// Version:		B.1
// Date:		15/04/04
// Author:		P R Truscott
...
///////////////////////////////////////////////////////////////////////////////
//
class G4TripathiLightCrossSectionModFH : public G4VCrossSectionDataSet
{
public:

  G4TripathiLightCrossSectionModFH();
  ~G4TripathiLightCrossSectionModFH();
...
inline void 
G4TripathiLightCrossSectionModFH::SetLowEnergyCheck (G4bool aLowEnergyCheck)
{
